...
const CONFIG = {
  ...
  hero: {
    ...
    socials: [
      { label: "LinkedIn", url: "https://www.linkedin.com/in/chandra-sailesh-b8584b24b/", icon: "linkedin" },
      { label: "GitHub", url: "https://github.com/Sailesh3000", icon: "github" },
      { label: "LeetCode", url: "https://leetcode.com/u/chandrasailesh30/", icon: "leetcode" },
      { label: "Medium", url: "https://medium.com/@saileshhedu", icon: "medium" },
    ],
  },
